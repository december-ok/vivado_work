...
HD_PWD='C:/Users/test/vivado/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Digit4_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Digit4_Display.tcl
