...
HD_PWD='C:/Users/test/vivado/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_counter_2bit_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_counter_2bit_7seg.tcl -notrace
